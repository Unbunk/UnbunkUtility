...
L["Switches your Details! profile by context: a raid context applies the raid profile, otherwise the dungeon profile."] = "Change ton profil Details! selon le contexte : un contexte raid applique le profil raid, sinon le profil donjon."
L["Details! not detected — install / enable it for this to work."] = "Details! non détecté — installe / active-le pour que ça fonctionne."
L["Switch based on"] = "Basculer selon"
L["By group type"] = "Le type de groupe"
L["By instance type"] = "Le type d'instance"
L["By group or instance"] = "Le groupe ou l'instance"
L["Raid profile name"] = "Nom du profil raid"
L["Dungeon profile name"] = "Nom du profil donjon"
...
L["Icons taken out of the Cooldown Manager. Pen/cross edit or delete a custom one; click an addon icon to open its settings; the + adds a new free custom icon."] = "Icônes retirées du Cooldown Manager. Crayon/croix pour modifier ou supprimer une icône personnalisée ; cliquez sur une icône d'addon pour ouvrir ses réglages ; le + ajoute une nouvelle icône libre."
