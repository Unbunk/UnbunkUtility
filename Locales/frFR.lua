...
L["Details! profile auto-switch"] = "Changement auto du profil Details!"
...
L["Unlock, then drag the Decursive Micro Unit Frame to reposition it; lock when you are done. (Out of combat only — the MUFs must be visible.)"] = "Déverrouille, puis glisse la Micro Unit Frame de Decursive pour la repositionner ; verrouille quand tu as fini. (Hors combat uniquement — les MUFs doivent être visibles.)"
...
L["Addon Icons"] = "Icônes de l'addon"
...
L["Move the Cooldown Manager. X / Y are measured from the centre of the screen. Unlock to drag it; Reset returns it to Edit Mode."] = "Déplace le Cooldown Manager. X / Y sont mesurés depuis le centre de l'écran. Déverrouille pour le glisser ; Réinitialiser le remet au mode Édition."
L["Border"] = "Bordure"
L["Display"] = "Affichage"
...
L["Below player frame settings"] = "Réglages du cadre sous le joueur"
...
L["Add custom CDM icon"] = "Ajouter une icône CDM personnalisée"
L["Edit custom CDM icon"] = "Modifier l'icône CDM personnalisée"
L["Enter the spell ID to add to this row:"] = "Entrez le spellID à ajouter à cette rangée :"
L["Spell ID:"] = "SpellID :"
L["Invalid spell ID:"] = "SpellID invalide :"
L["This row is full."] = "Cette rangée est pleine."
L["Enter a spell ID or name to add to this row:"] = "Entrez un ID ou un nom de sort à ajouter à cette rangée :"
...
L["Enter the buff's spell (above) to set up its Buff groups appearance."] = "Entrez le sort du buff (ci-dessus) pour configurer son apparence dans les Groupes de buffs."
...
L["Spell (ID or name)"] = "Sort (ID ou nom)"
L["Timer"] = "Minuteur"
...
L["Stacks color"] = "Couleur des charges"
...
L["Custom icons taken out of the Cooldown Manager. Click the pen to edit or the cross to delete one."] = "Icônes personnalisées retirées du Cooldown Manager. Cliquez sur le crayon pour modifier ou sur la croix pour supprimer."
...
L["Enter a spell ID or name:"] = "Entrez un ID ou un nom de sort :"
...
L["Bar position (offset from screen center)"] = "Position de la barre (décalage depuis le centre de l'écran)"
...
L["Bar colours"] = "Couleurs de la barre"
...
L["When enabled, this arranges the native Essential Cooldown Manager icons into groups and takes over the Essential viewer (the old Essentials placement is ignored)."] = "Une fois activé, ceci organise les icônes du Cooldown Manager Essentiel natif en groupes et prend le contrôle de l'afficheur Essentiel (l'ancien placement Essentiel est ignoré)."
...
L["A custom layout built from the native buff Cooldown Manager. Drag buff icons between groups; each group has its own placement, border and icon size."] = "Une disposition personnalisée construite à partir du Cooldown Manager natif des buffs. Glissez les icônes de buff entre les groupes ; chaque groupe a son propre placement, sa bordure et sa taille d'icône."
...
L["Quick add"] = "Ajout rapide"
-- ── Cooldown groups: multi-row + custom cooldowns ────────────────────────────
L["Rows"] = "Rangées"
L["Row %d"] = "Rangée %d"
L["Row is full"] = "Rangée pleine"
L["Max icon per row"] = "Icônes max par rangée"
L["New row"] = "Nouvelle rangée"
L["Add custom"] = "Ajouter une icône personnalisée"
L["Custom cooldown"] = "Cooldown personnalisé"
L["Reset to group"] = "Réinitialiser au groupe"
L["Reset all overrides"] = "Réinitialiser toutes les surcharges"
