...
L["Reveal (show fully) when"] = "Réafficher (pleine opacité) si"
...
L["Experimental fade for the Cooldown Manager and Player Frame."] = "Fondu expérimental pour le Cooldown Manager et le cadre du joueur."
L["Reveal on hover of"] = "Réafficher au survol de"
...
L["Owner access key. Enter your key to unlock the owner area on your account; it is never stored in clear."] = "Clé d'accès propriétaire. Saisissez votre clé pour débloquer la zone propriétaire sur votre compte ; elle n'est jamais stockée en clair."
L["Enter a Special Key first."] = "Saisissez d'abord une clé spéciale."
