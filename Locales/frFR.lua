...
-- Personal utilities: restore baked-in profile
L["Import profiles"] = "Importer des profils"
L["Import my profile"] = "Importer mon profil"
...
L["Dominos can't export — capture your CURRENT Dominos profile here, copy it, and paste it into AddonProfiles.lua's dominos blob."] = "Dominos ne peut pas exporter — capture ici ton profil Dominos ACTUEL, copie-le, et colle-le dans le blob dominos de AddonProfiles.lua."
L["Capture current Dominos profile"] = "Capturer le profil Dominos actuel"
L["Dominos not loaded (or serializer missing)."] = "Dominos non chargé (ou sérialiseur manquant)."
L["Prat has no export button — capture your CURRENT Prat profile here, copy it, and paste it into AddonProfiles.lua's prat blob."] = "Prat n'a pas de bouton d'export — capture ici ton profil Prat ACTUEL, copie-le, et colle-le dans le blob prat de AddonProfiles.lua."
L["Capture current Prat profile"] = "Capturer le profil Prat actuel"
L["Prat not loaded (or no active profile)."] = "Prat non chargé (ou aucun profil actif)."
...
L["%s imported. A UI reload is needed to fully apply it. Reload now?"] = "%s importé. Un /reload est nécessaire pour l'appliquer complètement. Recharger maintenant ?"
...
L["Name the profile to create from your baked-in backup:"] = "Nom du profil à créer depuis ta sauvegarde intégrée :"
L["Imports the UnbunkUtility profile hardcoded in the addon into a new profile (non-destructive), in case you lose your settings."] = "Importe le profil UnbunkUtility codé en dur dans l'addon vers un nouveau profil (non destructif), au cas où tu perds tes réglages."
L["Profile imported."] = "Profil importé."
L["Import failed."] = "Échec de l'import."
L["No backup profile is baked in."] = "Aucun profil de sauvegarde n'est intégré."
...
-- Personal utilities: hide focus debuffs, keep stacks
L["Focus buffs"] = "Buffs du focus"
L["Disable focus debuffs (keep stacks)"] = "Désactiver les débuffs du focus (garder les stacks)"
L["Hides the debuff icons on the default Blizzard focus frame while keeping their stack count, so only stacking debuffs stay visible (as a number)."] = "Cache les icônes de débuff sur le cadre de focus Blizzard par défaut tout en gardant leur nombre de stacks, donc seuls les débuffs à stacks restent visibles (sous forme de nombre)."
...
L["Save the action-bar contents (spells, macros, items) of your main character, then put them back on any new character in one click. Out of combat only. Spells your character doesn't know and character-macros it doesn't have are skipped; key bindings and account macros already carry over on their own."] = "Sauvegarde le contenu des barres (sorts, macros, objets) de ton perso principal, puis le remet sur n'importe quel nouveau perso en un clic. Hors combat uniquement. Les sorts que ton perso ne connaît pas et les macros perso absentes sont ignorés ; les raccourcis clavier et les macros de compte suivent déjà d'eux-mêmes."
L["Places the saved template onto THIS character's bars (overwrites those slots, leaves the rest). Do this on a fresh character, after your class spells are set up."] = "Place le modèle enregistré sur les barres de CE perso (écrase ces slots, laisse le reste). À faire sur un perso neuf, une fois tes sorts de classe en place."
...
L["Show icon at 0 stacks"] = "Afficher l'icône à 0 charge"
