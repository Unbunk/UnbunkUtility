...
L["Shown in the Buffs viewer (Buff groups). Set its in-CDM look on the Buff groups tab."] = "Affiché dans le viewer Buffs (Groupes de buffs). Réglez son apparence en CDM dans l'onglet Groupes de buffs."
