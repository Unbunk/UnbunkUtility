...
L["Announce a reload in group chat"] = "Annoncer un rechargement dans le chat de groupe"
L["Message"] = "Message"
L["Message sent on reload"] = "Message envoyé au rechargement"
L["Drag a row up/down to set priority. The message is sent to the highest CHECKED channel available in your group."] = "Glissez une ligne vers le haut/bas pour définir la priorité. Le message est envoyé au canal COCHÉ le plus prioritaire disponible dans ton groupe."
