...
L["Native CDM icon"] = "Icône CDM native"
L["Stop customizing"] = "Arrêter la personnalisation"
L["Stop customizing this native icon?"] = "Arrêter de personnaliser cette icône native ?"
L["The native cooldown icon returns to its default Blizzard look."] = "L'icône de cooldown native retrouve son apparence Blizzard par défaut."
L["No native cooldowns detected (open the Cooldown Manager with cooldowns showing)."] = "Aucun cooldown natif détecté (ouvre le Cooldown Manager avec des cooldowns affichés)."
